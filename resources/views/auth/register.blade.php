<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="country" :value="__('Gyvenamoji šalis')" />
                <?php
            ...
            <div class="form-check"><input class="form-check-input" type="checkbox" name="terms" value="1" required id="formCheck-1" @if(old('terms')) checked @endif ><label class="form-check-label" for="formCheck-1">Perskaičiau ir sutinku su privatumo politika</label></div>
            <div class="form-check"><input class="form-check-input" type="checkbox" name="newsletter" value="1" id="formCheck-2" @if(old('newsletter')) checked @endif ><label class="form-check-label" for="formCheck-2">Sutinku gauti naujienlaiškius</label></div>
