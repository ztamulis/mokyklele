...
<html lang="en">
  <head>
    ...
    <base href="">
    <title>Puslapio builderis</title>

	  <link href="/css/codemirror.css" rel="stylesheet"/>
	  <link href="/css/theme/material.css" rel="stylesheet"/>

	  <link href="/css/editor.css" rel="stylesheet"/>
	  <link href="/css/line-awesome.css" rel="stylesheet"/>
	  <link href="/css/vvvebjs-editor-helpers.css" rel="stylesheet"/>
...
<body>
	...
	<div id="vvveb-builder">
				...
				<div id="top-panel">
					...
					<div class="btn-group float-left" role="group">
					  <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="/images/icons/file-manager-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="/images/icons/left-column-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
						  <img src="/images/icons/right-column-layout.svg" width="20px" height="20px">
					  </button>
					</div>
					...
					<div class="btn-group mr-3 float-right" role="group">
						<button class="btn btn-primary btn-icon" title="Export (Ctrl + E)" id="save-btn" data-vvveb-action="saveAjax" data-vvveb-url="../save.php" data-v-vvveb-shortcut="ctrl+e">
							<i class="la la-save"></i> <span data-v-gettext>Išsaugoti puslapį</span>
						</button>
					</div>
				...
				<div id="left-panel">
					  ...
					  <div id="filemanager"> 
							<div class="header">
								<a href="#" class="text-secondary">Puslapiai</a>
									...
									<div class="btn-group responsive-btns mr-4 float-right" role="group">
									  <button class="btn btn-link btn-sm" title="New file" id="new-file-btn" data-vvveb-action="newPage" data-vvveb-shortcut="">
										  <i class="la la-file"></i> <small>Naujas puslapis</small>
									  </button>
							...
							<div id="select-box">
								...
								<div id="wysiwyg-editor">
										...
										<select class="custom-select">
											...
											<option value="DIN, sans-serif">DIN Next</option>
											...
											<option value="'Playfair Display', 'Vollkorn', serif">Playfair Display</option>
										</select>
								</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text">
		...
		<div class="form-group row" data-key="href">     
			...
			<div class="col-sm-9 input">
				<div>   
					<input name="file" type="text" class="form-control" placeholder="my-page" required>
				</div>
			</div>     
		</div>
      </div>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary btn-lg" type="submit"><i class="la la-check"></i> Sukurti naują puslapį</button>
        <button class="btn btn-secondary btn-lg" type="reset" data-dismiss="modal"><i class="la la-close"></i> Atšaukti</button>
      </div>
    </div>
...
<script>
	$('#iframe1').on('load', function(){
		$('#iframe1').contents().find('header').remove();
		$('#iframe1').contents().find('footer').remove();
	});
...
$(document).ready(function() {
	...
	[
			...
			?>
				{name:"<?= $fileName ?>", title:"<?= $fileName ?>",  url: "<?= "/".str_replace("_", "-", str_replace(".blade.php", "", substr($pathInfo['basename'],1))) ?>", file: "<?= resource_path('views/landing/').substr($pathInfo['basename'],1) ?>"},
			<?php } ?>
	]);
	Vvveb.FileManager.loadPage('Main');
});
</script>
</body>
</html>
