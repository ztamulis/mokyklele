            ...
            <div class="row">
                <div class="col-xl-8">
                    <form action="/dashboard/groups/{{ $group->slug }}" method="POST">
                        ...
                        <div class="form-group"><small class="form-text text-muted">Laikas ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }} formatu,  {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small>
                            <input class="form-control" type="text" name="time" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }}" value="{{ !empty($group->time) ? \App\TimeZoneUtils::updateTime(Carbon\Carbon::parse(Carbon\Carbon::parse($group->updated_at)->format('Y-m-d').$group->time->format('H:i'))->timezone('Europe/London'), $group->updated_at)->format('H:i') : "" }}"></div>
                        <div class="form-group"><small class="form-text text-muted">Laikas 2 ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }} formatu,  {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small>
                            <input class="form-control" type="text" name="time_2" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }}" value="{{ !empty($group->time_2) ? \App\TimeZoneUtils::updateTime(Carbon\Carbon::parse(Carbon\Carbon::parse($group->updated_at)->format('Y-m-d ').$group->time_2->format('H:i'))->timezone('Europe/London'), $group->updated_at)->format('H:i') : "" }}"></div>
                        <div class="form-group"><small class="form-text text-muted">Pradžios data ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d\TH:i') }} formatu,  {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small>
                            <input class="form-control" type="datetime-local" name="start_date" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d\TH:i') }}" value="{{ $group->start_date ? \App\TimeZoneUtils::updateTime(Carbon\Carbon::parse($group->start_date)->timezone('Europe/London'), $group->updated_at)->format('Y-m-d\TH:i') : "00:00" }}"></div>
                        <div class="form-group"><small class="form-text text-muted">pabaigos data ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d\TH:i') }} formatu,  {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small>
                            <input class="form-control" type="datetime-local" name="end_date" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d\TH:i') }}" value="{{ $group->end_date ? \App\TimeZoneUtils::updateTime(Carbon\Carbon::parse($group->end_date)->timezone('Europe/London'), $group->updated_at)->format('Y-m-d\TH:i') : "00:00" }}"></div>
