            ...
            <div class="row">
                <div class="col-xl-8">
                    <form action="/dashboard/groups" method="POST">
                        ...
                        <div class="form-group"><small class="form-text text-muted">Laikas ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }} formatu, {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small><input class="form-control" type="text" name="time" placeholder="{{Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }}" value="{{ old("time") }}"></div>
                        <div class="form-group"><small class="form-text text-muted">Laikas 2 ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }} formatu, {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small><input class="form-control" type="text" name="time_2" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('H:i') }}" value="{{ old("time_2") }}"></div>
                        <div class="form-group"><small class="form-text text-muted">Pradžios data ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d H:i') }} formatu,  {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small>
                            <input class="form-control" type="datetime-local" name="start_date" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d H:i') }}" value=""></div>
                        <div class="form-group"><small class="form-text text-muted">pabaigos data ({{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d H:i') }} formatu,  {{ \App\TimeZoneUtils::currentGmtModifierText() }})</small>
                            <input class="form-control" type="datetime-local" name="end_date" placeholder="{{ Carbon\Carbon::now()->timezone('Europe/London')->format('Y-m-d H:i') }}" value=""></div>
