<x-user>
    <div class="container--other">
        ...
        @endif
        <h3 class="text-dark mb-4">Redaguoti patarimų puslapį</h3>
        <div class="card"></div>
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-8">
                        <form action="{{route('pages.suggestions-config.update')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group"><button class="btn btn-primary" type="submit">Atnaujinti patarimą</button></div>
                        </form>
                    </div>
                </div>
            </div>
