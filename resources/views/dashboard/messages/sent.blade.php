<x-app-layout>
    <div class="client--dashboard">
        ...
        <h3>Išsiųsti pranešimai</h3>
        <p>Jūsų pranešimų dėžutėje yra {{ Auth::user()->sentMessages()->has('user')->count() }} pranešim.</p>
            ...
            <div class="group--item" data-href="/dashboard/messages/{{ $message->id }}">
                ...
                <div class="group--actions">
                    ...
                    <div class="group--actions--dropdown" style="display: none;">
                        ...
                        <form action="/dashboard/messages/{{ $message->id }}" method="POST" onsubmit="return confirm('Ar tikrai norite ištrinti žinutė?')">
                            @csrf
                            @method('DELETE')
