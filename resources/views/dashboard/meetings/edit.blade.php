<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-xl-8">
                    <form action="/dashboard/meetings/{{ $meeting->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="form-group">
                            ...
                            @endphp
                            <input class="form-control" type="datetime-local" name="date_at" max="{{ $todayY }}" placeholder="{{ date("Y-m-d\TH:i") }}" value="{{ $meeting->adminTime->format("Y-m-d\TH:i") }}">
                        </div>
                        <div class="form-group">
