<x-app-layout>
    ...
    @endif
    <h3 class="text-dark mb-4">Pridėti apdovanojimą</h3>
    <div class="card"></div>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-xl-8">
                    <form action="/dashboard/rewards" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <small class="form-text text-muted">Pavadinimas</small>
                            <input class="form-control" type="text" name="name" placeholder="Trofėjus" value="{{ old("name") }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group"><small class="form-text text-muted">Lankytų pamokų dėl apdovanojimo skaičius (-1 Jeigu norite padaryti priskyrima patys)</small>
                            <input class="form-control" type="number" name="attendance_to_get_reward" value="{{ old("attendance_to_get_reward") }}" maxlength="30">
                        </div>
                        ...
                        <div class="form-group"><button class="btn btn-primary" type="submit">Pridėti apdovanojimą</button></div>
                    </form>
                </div>
            </div>
        </div>
