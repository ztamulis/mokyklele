    ...
    <div class="container--other">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-8">
                        <form action="{{route('pages.suggestions-config.list.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method("POST")
                            <div class="form-group">
                                <small class="form-text text-muted">Pavadinimas</small>
                                <input class="form-control" type="text" name="title" placeholder="Patarimas" value="">
                            </div>
                            <div class="form-group">
