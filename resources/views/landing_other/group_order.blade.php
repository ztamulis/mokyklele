...
@section("content")
    ...
    @if(isset($done_message))
        <div class="text-center">
            <h3 style="color: #54efd1;">{{ $done_message }}</h3>
            ...
            <form method="POST">
                ...
                @if($group->adjustedPrice() > 0)
                    ...
                    <select name="payment_method" required>
                        <option value="new">Pridėti kortelės duomenis</option>
                    </select>
                    <div class="add_payment_method" >
                        <input id="card-holder-name" class="form-control" type="text" placeholder="Mokėtojo vardas ir pavardė">
                        ...
                        <div class="clear"></div>
                        <div id="card-button" class="button text--center" data-secret="{{ $intent->client_secret }}" style="opacity: 0; pointer-events: none;">
                            Išsaugoti kortelę
                        </div>
                    </div>
                    <br>
                    ...
                    <label><input type="radio" name="payment_type" value="single" checked> Už vieną kursą</label><br>
                    @if(false && !$group->hasAdjustedPrice())
                        <label><input type="radio" name="payment_type" value="subscription"> Tiesioginis debetas</label>
                    @endif
                    <br><br>
                    <div class="subscription--info" style="display: none">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vitae dignissim ex. Quisque eget massa sit amet lectus pharetra pulvinar non vel sem. Proin facilisis massa vitae justo iaculis, ut rhoncus lorem consequat. Nunc sodales elit eu nisi sollicitudin ornare. Aenean purus ante, rhoncus eu est dapibus, blandit vehicula metus. Interdum et malesuada fames ac ante ipsum primis in faucibus. Mauris ultrices vel nulla et consequat. Vivamus eget laoreet mauris. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin non volutpat enim, egestas gravida urna. Quisque non turpis in nulla tempor lobortis. Quisque sed bibendum neque, non iaculis augue. Proin accumsan dolor sapien, quis vestibulum elit sagittis congue. Donec vulputate diam facilisis turpis aliquam accumsan. Vestibulum ac ullamcorper tellus, sed viverra dolor.
                    </div>
                @else
